...
import { DataCollectorInjectionKey } from '../context';
import type { DataCollectorContext } from '../context';
...
export default function useMenuDataCollector(props: { key?: string | undefined; type: 'menu' | 'popupMenu' | 'subMenu' }) {
