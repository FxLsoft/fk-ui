...
import type { I18nMessages, LocalLang } from './interface';

const LOCALE = ref('zh-CN');
const I18N_MESSAGES = reactive<I18nMessages>({
	'zh-CN': zhCN,
});
...
export const useI18n = () => {
	...
	const i18nMessage = computed<LocalLang>(() => configProvider?.locale ?? I18N_MESSAGES[LOCALE.value]);
