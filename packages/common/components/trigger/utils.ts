...
import { getDocumentSize } from '../_utils/dom';
import type { DocSize } from '../_utils/dom';
import type { CSSProperties } from 'vue';
import type { TriggerPosition } from '../_utils/constant';
import type { TriggerPopupTranslate } from './interface';

const getViewPortSize = (): DocSize => {
...
/**
 * @zh 获取元素的滚动区域
 * @en Get the scroll area of the element
 * @param element
 * @param containerRect
 */
 ...
 * @param containerRect
 * @param triggerRect
 * @param popupRect Popup box size
 * @param offset Custom offset
 * @param translate Custom translation
 * @param customStyle Custom style
 * @param autoFitPosition Whether to automatically adjust the position of the pop-up box
 */
