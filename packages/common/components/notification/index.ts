...
import type { NotificationConfig, NotificationItem, NotificationMethod, NotificationPosition } from './interface';
...
class NotificationManger {
	...
	add = (config: _NotificationConfig) => {
		...
		const id = config.id ?? `__notification_${this.notificationCount}`;
