...
import { isArray, isDayjs, isQuarter } from './is';
...
export function isValueChange(prevValue: Dayjs | (Dayjs | undefined)[] | undefined, currentValue: Dayjs | (Dayjs | undefined)[] | undefined) {
...
type DateValue = Date | string | number | Dayjs;
...
export function getDayjsValue(time: DateValue[] | undefined, format: string): Dayjs[] | undefined;
export function getDayjsValue(time: (DateValue | undefined)[], format: string): (Dayjs | undefined)[];
export function getDayjsValue(time: (DateValue | undefined)[] | undefined, format: string): (Dayjs | undefined)[] | undefined;
export function getDayjsValue(time: DateValue | (DateValue | undefined)[] | undefined, format: string): Dayjs | (Dayjs | undefined)[] | undefined;
export function getDayjsValue(time: DateValue | DateValue[] | (DateValue | undefined)[] | undefined, format: string) {
	...
	const formatValue = (value: Date | string | number | undefined | Dayjs) => {
...
export function getDateValue(value: Dayjs[]): Date[];
export function getDateValue(value: (Dayjs | undefined)[]): (Date | undefined)[];
export function getDateValue(value: (Dayjs | undefined)[] | undefined): (Date | undefined)[] | undefined;
export function getDateValue(value: Dayjs | (Dayjs | undefined)[]): Date | (Date | undefined)[];
export function getDateValue(value: Dayjs | (Dayjs | undefined)[] | undefined): Date | (Date | undefined)[] | undefined;
...
export function pickDataAttributes<T extends Record<string, any>, K extends keyof T>(obj: T): { [key in K]: any } {
