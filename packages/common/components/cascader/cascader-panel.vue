<template>
	<base-cascader-panel :display-columns="displayColumns" :selected-path="selectedPath" :active-key="activeKey"
		:multiple="multiple" :total-level="totalLevel" :check-strictly="checkStrictly" @keydown="handleKeyDown">
...
import { getCheckedStatus, getLeafOptionInfos, getLeafOptionKeys, getOptionInfos, getValidValues, getValueKey } from './utils';
...
export default defineComponent({
	...
	setup(props, { emit, slots }) {
		const { options, checkStrictly, loadMore, modelValue, valueKey, expandChild, expandTrigger } = toRefs(props);
