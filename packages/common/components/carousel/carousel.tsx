import { computed, defineComponent, onBeforeUnmount, provide, reactive, ref, toRefs, watchEffect } from 'vue';
...
export default defineComponent({
	...
	setup(props, { emit, slots }) {
		...
		function slideTo({ targetIndex, isNegative = false, isManual = false }: { targetIndex: number; isNegative?: boolean; isManual?: boolean }) {
