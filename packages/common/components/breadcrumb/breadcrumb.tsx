import { computed, defineComponent, mergeProps, provide, reactive, ref, toRefs } from 'vue';
...
export default defineComponent({
	...
	setup(props, { slots }) {
		...
		const defaultItemRender = (route: BreadcrumbRoute, routes: BreadcrumbRoute[], paths: string[]) => {
