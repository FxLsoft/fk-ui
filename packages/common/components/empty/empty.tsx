...
export default defineComponent({
	...
	setup(props, { slots, attrs }) {
		...
		return () => {
			if (!props.inConfigProvider && configCtx?.slots.empty && !(slots.image || props.imgSrc || props.description)) {
			...
			return (
				<div class={prefixCls} {...attrs}>
					<div class={`${prefixCls}-image`}>
						{slots.image?.() ?? (props.imgSrc ? <img src={props.imgSrc} alt={props.description || 'empty'} /> : <IconEmpty />)}
					</div>
