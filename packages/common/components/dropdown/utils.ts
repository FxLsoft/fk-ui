import { getChildrenString, isArrayChildren, isNamedComponent, isSlotsChildren, resolveProps } from '../_utils/vue-utils';
import { isArray, isObject } from '../_utils/is';
import { omit } from '../_utils/omit';
import type { DGroup, DSubmenu, DropdownOption } from './interface';
