...
export default (originElement: HTMLElement, ellipsisConfig: EllipsisInternalConfig, operations: VNodeTypes | VNodeTypes[], fullText: string) => {
	...
	ellipsisTextNode.before(textNode);
