import type { FormInstance, PaginationInstance, PaginationProps } from '@erp/common';
import type {
...
import type { VxeToolbarInstance, VxeToolbarPropTypes, VxeToolbarProps } from './toolbar';
import type { TableMethods, VxeTableConstructor, VxeTableDefines, VxeTableEmits, VxeTableInstance, VxeTableProps } from './table';
import type { ComputedRef, Ref, RenderFunction, SetupContext } from 'vue';
...
export interface GridPrivateRef<D = any> {
	...
	refForm: Ref<FormInstance>;
	refToolbar: Ref<VxeToolbarInstance>;
	refPager: Ref<PaginationInstance>;
}
...
export namespace VxeGridPropTypes {
	...
	export interface PagerConfig extends PaginationProps {
		enabled?: boolean;
		showSelected?: string;
		slots?: any;
	}
	...
	export interface ProxyConfig<D = any> {
		...
		form?: boolean;
		response?: {
			list?: string | null | ((params: { data: any; $grid: VxeGridConstructor<D> }) => any[]);
			result?: string | ((params: { data: any; $grid: VxeGridConstructor<D> }) => any[]);
			total?: string | ((params: { data: any; $grid: VxeGridConstructor<D> }) => number);
			message?: string | ((params: { data: any; $grid: VxeGridConstructor<D> }) => string);
		};
		ajax?: {
...
export namespace VxeGridDefines {
	...
	export interface PageChangeEventParams<D = any> extends GridEventParams<D> {
		type: 'current' | 'pageSize';
		pageSize: number;
		current: number;
	}
	export interface FormSubmitEventParams<D = any> extends GridEventParams<D> {}
	export interface FormSubmitInvalidEventParams<D = any> extends GridEventParams<D> {}
	export interface FormResetEventParams<D = any> extends GridEventParams<D> {}
	export interface FormCollapseEventParams<D = any> extends GridEventParams<D> {}
...
export interface VxeGridSlots<D = any> {
	 ...
	 * 自定义表单模板
	 */
	form?(params: { $table: VxeTableConstructor<D>; $grid: VxeGridConstructor<D> | null | undefined }): any;
	/**
	 * 自定义工具栏模板
	 */
	toolbar?(params: { $table: VxeTableConstructor<D>; $grid: VxeGridConstructor<D> | null | undefined }): any;
	/**
	 * 自定义表格顶部模板
	 */
	top?(params: { $table: VxeTableConstructor<D>; $grid: VxeGridConstructor<D> | null | undefined }): any;
	/**
	 * 自定义表格底部模板
	 */
	bottom?(params: { $table: VxeTableConstructor<D>; $grid: VxeGridConstructor<D> | null | undefined }): any;
	/**
	 * 自定义表格左侧模板
	 */
	left?(params: { $table: VxeTableConstructor<D>; $grid: VxeGridConstructor<D> | null | undefined }): any;
	/**
	 * 自定义表格右侧模板
	 */
	right?(params: { $table: VxeTableConstructor<D>; $grid: VxeGridConstructor<D> | null | undefined }): any;
	/**
	 * 自定义分页模板
	 */
	pager?(params: { $table: VxeTableConstructor<D>; $grid: VxeGridConstructor<D> | null | undefined }): any;
}
