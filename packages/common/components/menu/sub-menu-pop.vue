<template>
	<Trigger
		...
		:show-arrow="false"
		:animation-name="needPopOnBottom ? 'menu-bottom' : 'menu-left'"
		...
		:wrapper-class="`${menuPrefixCls}-popup-wrapper`"
		:get-target="getTarget"
		:scrollbar-props="scrollbarProps"
		:auto-fit-popup-width="!!getTarget"
		v-bind="triggerProps"
	...
	setup(props) {
		...
		const classNames = computed(() => [
			...
			`${prefixCls.value}-header`,
			{
				...
				[`${menuPrefixCls.value}-open`]: popVisible.value,
			},
		]);
