...
export function normalizeRangeValue(value: (CalendarValue | undefined)[] | CalendarValue | undefined) {
...
export function isCompleteRangeValue(value: Array<Dayjs | undefined> | undefined): value is [Dayjs, Dayjs] {
	return !!value && isDayjs(value[0]) && isDayjs(value[1]);
}

export function isValidRangeValue(value: Array<Dayjs | undefined> | undefined): value is undefined | [] | [Dayjs, Dayjs] {
