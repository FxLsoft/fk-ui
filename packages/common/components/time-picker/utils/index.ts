...
export function getFormattedValue(time: Dayjs | Dayjs[], format: string): string | string[];
export function getFormattedValue(time: Dayjs | Array<Dayjs | undefined> | undefined, format: string): string;
export function getFormattedValue(time: Dayjs | undefined, format: string): string | undefined;
export function getFormattedValue(time: Array<Dayjs | undefined> | undefined, format: string): Array<string | undefined> | undefined;
export function getFormattedValue(time: Dayjs | Array<Dayjs | undefined> | undefined, format: string): string | Array<string | undefined> | undefined {
