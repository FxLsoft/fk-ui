...
import type { AppContext, CSSProperties, Component, StyleValue } from 'vue';
...
export type ModalUpdateConfig = Omit<
	ModalConfig,
	'title' | 'content' | 'footer' | 'onOk' | 'onCancel' | 'onBeforeOk' | 'onBeforeCancel' | 'onOpen' | 'onClose' | 'onBeforeOpen' | 'onBeforeClose'
>;
