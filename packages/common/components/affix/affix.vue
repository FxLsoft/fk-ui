...
import { isUndefined, isWindow } from '../_utils/is';
	...
	setup(props, { emit }) {
		...
		onMounted(() => {
			...
			watchEffect(onInvalidate => {
				const element = (target && target.value !== window && getElement(target.value as string | HTMLElement)) || window;
			...
			watchEffect(onInvalidate => {
				...
				const container = (targetContainer && targetContainer.value !== window && getElement(targetContainer.value as string | HTMLElement)) || window;
