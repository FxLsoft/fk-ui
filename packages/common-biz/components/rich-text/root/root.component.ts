import { Component, ContentType, Registry, Selection, Slot, onContentInsert, useContext } from '@textbus/core';
import { ParagraphComponent } from '../paragraph/paragraph.component';
import type { ComponentStateLiteral, Textbus } from '@textbus/core';
