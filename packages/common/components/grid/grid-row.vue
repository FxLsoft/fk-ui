...
export default defineComponent({
	...
	props: {
		 ...
		 */
		gutter: {
			type: [Number, Object, Array] as PropType<number | ResponsiveValue | [number | ResponsiveValue, number | ResponsiveValue]>,
			default: 0,
		},
		/**
	...
	setup(props) {
		...
		const resultGutter = computed<[number, number]>(() => [gutterHorizontal.value, gutterVertical.value]);
		provide(
